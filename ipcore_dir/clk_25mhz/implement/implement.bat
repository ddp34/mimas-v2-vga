...
xst -ifn xst.scr
move clk_25mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_25mhz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_25mhz_exdes.ucf clk_25mhz_exdes

echo 'Running map'
map -timing -pr b clk_25mhz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_25mhz_exdes -w routed.ncd routed.v
cd ..
